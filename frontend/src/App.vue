...
<template>
  <div class="app-layout">
    ...
    <aside class="sidebar" :class="{ 'is-open': mobileMenu }">
      <a class="brand" href="#chat" @click.prevent="navigate('chat')"><span class="brand-icon"><Layers3 :size="23" /></span><span>Epoch<span class="brand-light">Flow</span><small>AGENT LEARNING STUDIO</small></span></a>
