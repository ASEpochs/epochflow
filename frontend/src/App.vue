...
<template>
  <div class="app-layout">
    ...
    <div class="main-shell">
      ...
      <footer class="app-footer"><span><i class="tiny-dot"></i> EpochFlow · 纪流</span><span>公开在线演示 <span class="footer-dot">·</span> 云端临时数据在休眠或重启后清除</span><span class="footer-version">v1.1 / MODEL STUDIO</span></footer>
    </div>
